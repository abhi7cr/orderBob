...
// module
exports.push([module.i, ".snackBarMessage, .mat-simple-snackbar {\n  color: #ff5722 !important; }\n\na, body, button, p, span, div {\n  font-family: 'Dosis', sans-serif; }\n", ""]);
...
var OrderService = (function () {
    function OrderService(http) {
        ...
        this.get = function (userId) {
            return _this.http.get('/api/users/+' + userId.toString() + '/orders', { headers: _this.headers }).map(function (res) { return res.json(); });
        };
        this.getById = function (id, userId) {
            return _this.http.get('/api/users/' + userId.toString() + '/orders/' + id, { headers: _this.headers }).map(function (res) { return res.json(); });
        };
