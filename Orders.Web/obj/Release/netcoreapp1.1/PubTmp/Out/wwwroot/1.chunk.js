...
var OrderService = (function () {
    function OrderService(http) {
        ...
        this.get = function (userId) {
            return _this.http.get('/api/users/' + userId + '/orders', { headers: _this.headers }).map(function (res) { return res.json(); });
        };
        this.getById = function (id, userId) {
            return _this.http.get('/api/users/' + userId + '/orders/' + id, { headers: _this.headers }).map(function (res) { return res.json(); });
        };
